...
public class SeekBarVertical extends AppCompatSeekBar {
    ...
    public void setRotationAngle(int angle) {
        ...
        if (useViewRotation()) {
            SeekBarVerticalWrapper wrapper = getWrapper();
            if (wrapper != null) {
    ...
    private SeekBarVerticalWrapper getWrapper() {
        final ViewParent parent = getParent();

        if (parent instanceof SeekBarVerticalWrapper) {
            return (SeekBarVerticalWrapper) parent;
        } else {
            return null;
        }
    }
