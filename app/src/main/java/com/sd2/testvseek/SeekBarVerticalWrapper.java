...
public class SeekBarVerticalWrapper extends FrameLayout {
    public SeekBarVerticalWrapper(Context context) {
        this(context, null, 0);
    }

    public SeekBarVerticalWrapper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SeekBarVerticalWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void onSizeChangedTraditionalRotation(int w, int h, int oldw, int oldh) {
        final SeekBarVertical seekBar = getChildSeekBar();
    ...
    private void applyViewRotation(int w, int h) {
        ...
        if (seekBar != null) {
            ...
            switch (rotationAngle) {
                case SeekBarVertical.ROTATION_ANGLE_CW_90:
                    ...
                    break;
                case SeekBarVertical.ROTATION_ANGLE_CW_270:
    ...
    private SeekBarVertical getChildSeekBar() {
        final View child = (getChildCount() > 0) ? getChildAt(0) : null;
        return (child instanceof SeekBarVertical) ? (SeekBarVertical) child : null;
    }
